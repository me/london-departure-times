...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baconjs = __webpack_require__(11);
	...
	if ((0, _jquery2.default)('body').is('#stops-page')) {
	  ...
	  var geoRequest = geoLocalize.map(function (it) {
	    return { url: '/api/stops', data: { lat: it.coords.latitude, lon: it.coords.longitude } };
	  }).ajax();

	  geoLocalize.onValue(function (it) {
	    (0, _jquery2.default)('#lat').val(it.coords.latitude);
	    (0, _jquery2.default)('#lon').val(it.coords.longitude);
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  if (typeof module !== "undefined" && module !== null) {
	    Bacon = __webpack_require__(11);
	    BaconModel = __webpack_require__(14);
	    $ = __webpack_require__(8);
	    module.exports = init(Bacon, BaconModel, $);
	  } else {
	    if (true) {
	      !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(14), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_FACTORY__ = (init), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    } else {
